...
const Register = () => {
    return (
        <div className="relative flex justify-center items-center min-h-screen bg-[#0a0a0a] overflow-hidden font-sansSelection">
            ...
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-purple-900/20 rounded-full blur-[120px] pointer-events-none animate-pulse" />
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#1DB954]/10 rounded-full blur-[120px] pointer-events-none animate-pulse" />
            ...
            <div className="relative z-10 flex flex-col justify-center items-center gap-8 w-full max-w-[440px] px-6">
                ...
                <div className="w-full bg-[#161616]/80 backdrop-blur-xl border border-white/5 p-8 rounded-[2rem] shadow-2xl flex flex-col gap-6">
                    <div className="space-y-1">
                        ...
                        <p className="text-[#9ca3af] text-sm">Join the sonic revolution today</p>
                    </div>

                    {/* Registration Form */}
                    <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-white/40 tracking-wider ml-1 uppercase">Full Name</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-white/40 tracking-wider ml-1 uppercase">Select Password</label>
                            <div className="relative group">
                    ...
                    <div className="mt-2 text-center">
                        <p className="text-sm text-[#9ca3af]">
                            ...
                            <a href="/login" className="text-white font-bold hover:text-[#1DB954] transition-colors">
                                Sign In
                            </a>
                        </p>
                    </div>
                ...
                <p className="text-[10px] text-white/20 font-medium text-center max-w-[300px] leading-relaxed">
                    By registering, you agree to our <span className="underline decoration-white/10 underline-offset-4">Terms of Service</span> and <span className="underline decoration-white/10 underline-offset-4">Privacy Policy</span>.
                </p>
            </div>
        </div>
    );
